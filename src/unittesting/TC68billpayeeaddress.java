...
public class TC68billpayeeaddress {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.name("payee.address.street")).sendKeys("_333 Bloor St E");
		...
		driver.findElement(By.name("payee.accountNumber")).sendKeys("10234");
		driver.findElement(By.name("verifyAccount")).sendKeys("10234");
